...
// Si ni siquiera ha iniciado sesión, directo al login
...
$cargos_autorizados = ['administrador', 'ventas'];
...
// Si pasa el escudo, cargamos la conexión y las variables del usuario
