...
<head>
    ...
    <title>La Argentina - Disponibilidad de Inventario</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .tabla-contenedor {
            width: 100%;
            overflow-x: auto;
            max-height: 650px; /* Mayor altura para mostrar más filas */
            overflow-y: auto;
...
<body>
    ...
    <div class="header-seccion">
        <h1>Control de <span>Disponibilidad</span></h1>
    ...
    <!-- MODAL DE EDICIÓN MÚLTIPLE (MAQUETA BASE) -->
